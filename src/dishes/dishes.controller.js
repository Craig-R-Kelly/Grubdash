...
/*  POST "/dishes"
    invoked next after `validateProperties()` and `validatePrice()`  */
...
/*****************************************
 *  controller functions for "/:dishId"  *
 *****************************************/

/*  GET "/dishes/:dishId"
    invoked next after `dishExists()`  */
...
/*  PUT "/dishes/:dishId"
    invoked next after `dishExists()`, `validateProperties()`, and `validatePrice()`  */
